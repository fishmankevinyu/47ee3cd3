    ...
    return (<div className="wrapper"> 
        <div className='container button-container'>
            <div className='row button' onClick={archiveAll}>
                <div className='col-2 icon-container'><img className='icon' src="https://cdn-icons-png.flaticon.com/512/1784/1784897.png" alt="" /></div>
                <div className='col-10 button-text'>Archive all calls</div>
            </div>
        </div>
